...
def find_input_size(folder, max_width, max_height):
    """
    :param folder: the folder containing the text files
    :param max_width: The maximum width of the input files
    :param max_height: The maximum height of the input files

    :return: The maximum width and height of all file in the folder
    """
    for root, dirs, files in os.walk(folder):
        for file in files:
            cur_height = 0
...
def find_input_size_1d(folder, max_width):
    ...
    :return: The maximum of digits at all token files in the folder.
    """
    for root, dirs, files in os.walk(folder):
        for file in files:
